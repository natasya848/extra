        ...
        <div class="col-md-6 col-12">
          <div class="card">
            <div class="card-content">
              <div class="card-body">
                <form class="form-horizontal" novalidate action="<?= base_url('jadwal/aksi_tambah_jadwal') ?>" method="post" enctype="multipart/form-data">
                  <div class="form-body">
...
<script>
  function loadSesi() {
    ...
    if (blok && rombel) {
      ...
      $.ajax({
        url: "<?= base_url('jadwal/getSesiTersedia') ?>",
        type: "POST",
        data: {
          id_blok: blok,
          id_rombel: rombel
  ...
  $('#blok, #rombel').on('change', loadSesi);
