...
<section>
  <div class="row match-height">
    <div class="col-md-6 col-12">
      <div class="card">
       <form action="<?= base_url('agendapkl/data_absensi_sekolah_all/export_windows')?>" method="post">
        <div class="card-header bg-primary">
          <h4 class="card-title text-white d-flex justify-content-center align-items-center">Form Laporan Absensi Windows Print</h4>
        </div>
    ...
    <div class="col-md-6 col-12">
          <div class="card">
           <form action="<?= base_url('agendapkl/data_absensi_sekolah_all/export_excel')?>" method="post">
            <div class="card-header bg-primary">
              <h4 class="card-title text-white d-flex justify-content-center align-items-center">Form Laporan Absensi Excel</h4>
            </div>
        ...
        <div class="col-md-6 col-12">
          <div class="card">
           <form action="<?= base_url('agendapkl/data_absensi_sekolah_all/export_pdf')?>" method="post">
            <div class="card-header bg-primary">
              <h4 class="card-title text-white d-flex justify-content-center align-items-center">Form Laporan Absensi PDF</h4>
            </div>
