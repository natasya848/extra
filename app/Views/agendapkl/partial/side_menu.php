<?php
$uri = service('uri');
$currentPath = trim($uri->getPath(), '/'); // ex: 'dashboard', 'agendapkl/data_absensi_sekolah'
      ...
      <div class="sidebar-menu">
        <ul class="menu">
          ...
          <?php foreach ($menus as $menu): ?>
            <?php
              $menuPath = trim($menu->link, '/');
              $isParentActive = $currentPath === $menuPath;
              $isChildActive = false;

              if (!empty($menu->children)) {
                foreach ($menu->children as $child) {
                  $childPath = trim($child->link, '/');
                  if ($currentPath === $childPath) {
                    $isParentActive = true;
                    $isChildActive = $childPath;
                    break;
                  }
                }
              }
