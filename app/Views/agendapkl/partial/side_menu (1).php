      ...
      <?php if (session()->get('level') == 1) { ?>
        <div class="sidebar-menu">
          <ul class="menu">
            ...
            <li class="sidebar-item <?php if ($uri->getSegment(1) == "dashboard") {
                                      echo "active";
                                    } ?>">
            ...
            <li class="sidebar-item <?php if ($uri->getSegment(1) == "laporan") {
                                      echo "active";
                                    } ?>">
            ...
            <li class="sidebar-item <?php if ($uri->getSegment(1) == "semester") {
                                      echo "active";
                                    } ?>">
            ...
            <li class="sidebar-item <?php if ($uri->getSegment(2) == "menu_print") {
                                      echo "active";
                                    } ?>">
...
<<!-- ?php } else if (session()->get('level') == 3) { ?>
  <div class="sidebar-menu">
    <ul class="menu">
      ...
      <li class="sidebar-item <?php if ($uri->getSegment(1) == "Data_absensi_guru") {
                                echo "active";
                              } ?>">
...
<!-- <?php } else if (session()->get('level') == 4) { ?>
  ...
  <div class="sidebar-menu">
    <ul class="menu">
      ...
      <li class="sidebar-item <?php if ($uri->getSegment(1) == "data_perizinan") {
                                echo "active";
                              } ?>">
      ...
      <li class="sidebar-item <?php if ($uri->getSegment(1) == "data_absensi_siswa") {
                                echo "active";
                              } ?>">
...
<?php } else if (session()->get('level') == 5) { ?>
  ...
  <div class="sidebar-menu">
    <ul class="menu">
      ...
      <li class="sidebar-item <?php if ($uri->getSegment(1) == "data_absensi_sekretaris" && $uri->getSegment(2) !== "menu_print") {
                                echo "active";
                              } ?>">
  ...
  <ul class="menu">
    ...
    <?php foreach ($menus as $menu): ?>
      <?php if ($menu->is_have_child == 0): ?>
        <li class="sidebar-item <?= ($uri->getSegment(1) == $menu->link) ? 'active' : '' ?>">
          <a class="sidebar-link" href="<?= base_url($menu->link); ?>">
            <i class="fa-solid fa-circle"></i> <!-- Ganti icon sesuai kebutuhan -->
            <span><?= $menu->title ?></span>
          </a>
        </li>
      <?php else: ?>
        <li class="sidebar-item has-sub <?= ($uri->getSegment(1) == $menu->link) ? 'active' : '' ?>">
          <a href="#" class='sidebar-link'>
            <i class="fa-solid fa-folder"></i> <!-- Ganti icon sesuai kebutuhan -->
            <span><?= $menu->title ?></span>
          </a>
          <ul class="submenu">
            <?php foreach ($menu->children as $submenu): ?>
              <li class="submenu-item <?= ($uri->getSegment(1) == $submenu->link) ? 'active' : '' ?>">
                <a href="<?= base_url($submenu->link); ?>"><?= $submenu->title ?></a>
              </li>
            <?php endforeach; ?>
          </ul>
        </li>
