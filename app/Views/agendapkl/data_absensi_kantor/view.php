<div id="main-content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 d-flex align-items-center">
            <a href="<?= base_url('agendapkl/data_absensi_kantor/create_all') ?>">
        ...
        <!-- Filter Tanggal -->
        <div class="col-md-6">
            <form method="get" action="<?= base_url('agendapkl/data_absensi_kantor/') ?>" class="d-flex justify-content-end">
    ...
    <div class="d-flex align-items-center">
        ...
        data-id="<?= $idAbsensi ?>"
        data-url="<?= base_url('agendapkl/data_absensi_kantor/aksi_edit_ajax') ?>"
        required>
