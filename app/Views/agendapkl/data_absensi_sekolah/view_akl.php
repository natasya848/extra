<div id="main-content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 d-flex align-items-center">
            <a href="<?= base_url('agendapkl/data_absensi_sekolah/create_all_akl') ?>">
        ...
        <!-- Filter Tanggal -->
        <div class="col-md-6">
            <form method="get" action="<?= base_url('agendapkl/data_absensi_sekolah/akl') ?>" class="d-flex justify-content-end">
    ...
    ?>
        <tr>
            ...
            <td>
    <?php if ($idAbsensi): ?>
    <div method="post" action="<?= base_url('agendapkl/data_absensi_sekolah/aksi_edit') ?>" class="d-flex align-items-center">
