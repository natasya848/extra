<div id="main-content">
    ...
    <div class="row">
        ...
        <div class="col-md-6 d-flex align-items-center">
            <a href="<?= base_url('agendapkl/data_absensi_sekolah/create_all_rpl') ?>">
        ...
        <!-- Filter Tanggal -->
        <div class="col-md-6">
            <form method="get" action="<?= base_url('agendapkl/data_absensi_sekolah/rpl') ?>" class="d-flex justify-content-end">
