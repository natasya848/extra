<div id="main-content">
	...
	<section class="section">
		<div class="card">
			<form action="<?= base_url('agendapkl/data_siswa/aksi_edit/')?>" method="post" class="row g-3" enctype="multipart/form-data">
					...
					<div class="row">
						<div class="col-lg-6 col-md-12">
							...
							<div class="mb-3 mt-3">
								...
								<input type="text" class="form-control" id="nama" placeholder="Masukkan Nama" name="nama" value="<?php echo $jojo->nama_siswa ?>" required>
							</div>
							<div class="mb-3 mt-3">
								<label for="namasiswa" class="form-label">NIS</label>
								<input type="text" class="form-control" id="nis" placeholder="Masukkan NIS" name="nis" value="<?php echo $jojo->nis ?>" required>
							</div>
							<div class="mb-3">
						...
						<div class="col-md-6">
							...
							<div class="mb-3">
								...
								<input type="text" class="form-control" id="telpon" placeholder="Masukkan Telpon" name="telpon" value="<?php echo $jojo->no_hp ?>" required>
							</div>
							<div class="mb-3">
									...
									<select class="form-select" id="rombel" name="rombel">
										...
										foreach ($rombel as $r) {
										?>
											<option value="<?= $r->id_rombel ?>"><?php echo $r->nama_kelas . '.' . $r->nama_r . ' - ' . $r->nama_jurusan ?></option>
										<?php } ?>
									</select>
								</div>
							<!-- form bagian kanan -->
