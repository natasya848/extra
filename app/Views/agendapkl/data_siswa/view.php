		...
		<section class="section">
			<div class="card">
				<div class="card-header">
					<a href="<?php echo base_url('agendapkl/data_siswa/create')?>"><button class="btn btn-primary mt-2"><i class="fa-solid fa-plus"></i>
					Tambah</button></a>
					<div class="btn-group">
						<div class="dropdown">
				...
				<div class="table-responsive">
					<table class="table table-striped" id="table1">
						...
						foreach ($jojo as $riz) {
							...
							<td>
								<a href="<?php echo base_url('agendapkl/data_siswa/edit/'. $riz->user)?>" class="btn btn-warning my-1"><i class="fa-solid fa-pen-to-square" style="color: #ffffff;"></i></a>
								<?php if(session()->get('level')== 1) { ?>
									<a href="<?php echo base_url('agendapkl/data_siswa/delete/'. $riz->user)?>" class="btn btn-danger my-1"><i class="fa-solid fa-trash"></i></a>
								<?php } ?>
							</td>
						</tr>
						<?php
